...
add_filter( 'plugin_action_links', function ($actions, $plugin_file, $plugin_data, $context) {
		...
		if ($plugin_file === 'wordpressmvc/wordpressmvc.php') {
			//$actions['link_to_home_page'] = '<a href="https://github.com/mavlutovr/wordpressmvc/" target="_blank"><img src="https://webdeveloper.pro/wp-content/plugins/wordpressmvc/logo.svg" alt=""></a>';
