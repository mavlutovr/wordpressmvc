...
* Более высокие позиции в поисковыках
	...
	* Даже без кешироваания сайт открывается достаточно быстро. Но можно поставить 
	дополнительный кеширующий плагин. Тогда сайт будет вообще летать. Что пололжительно
