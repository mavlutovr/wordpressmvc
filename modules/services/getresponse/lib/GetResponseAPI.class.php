...
class GetResponse
{
	 ...
	 * @return object
	 */
	public function getContacts($campaigns = null, $operator = 'CONTAINS', $comparison = '%', $fields = array('name' => false, 'email' => false))
	{
		$params = null;
		if(is_array($campaigns)) $params['campaigns'] = $campaigns;
	...
	private function execute($request)
	{
		...
		if ($response->error) {
			...
			//echo("GetResponseApi.class.php\n\n<BR><BR>\n\n");
			//print_r($response->error);
			/*print_r($request);*/
			wdpro_error("GetResponse", $response->error);
			
			//throw new \Wdpro\Exception($response->error);
		}
