...
dialog_templates.window = function(opt_data, opt_ignored) {
  return '<div class="dialog js-dialog"><div class="dialog-header"><table class="table_100 table_top"><tr><td class="dialog_title_td"><div class="JS_dialog_title dialog-title"></div></td><td class="dialog_close_td"><div class="JS_dialog_close" title="\u0417\u0430\u043A\u0440\u044B\u0442\u044C">\u2715</div></td></tr></table></div><div class="JS_dialog_content dialog-content"></div></div>';
};
if (goog.DEBUG) {
...
dialog_templates.substrate = function(opt_data, opt_ignored) {
  return '<div class="dialog_substrate"></div>';
};
if (goog.DEBUG) {
